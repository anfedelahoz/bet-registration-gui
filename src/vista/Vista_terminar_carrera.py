...
class Dialogo_terminar_carrera(QDialog,):
    ...
    def __init__(self, competidores):
        ...
        print("Vista Terminar Carrera" + str(len(self.competidores)))
        print("self.competidores[0]['probabilidad']" + str(self.competidores[0].id_competidor))
        for competidor in self.competidores:
            print(str(competidor.probabilidad))
            self.combobox_competidores.addItem(competidor.nombre, userData=competidor.id_competidor) 
        #     self.combobox_competidores.addItem(competidor["probabilidad"], userData=i)   
