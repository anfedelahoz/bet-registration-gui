...
class Vista_lista_apostadores(QWidget):
    ...
    def mostrar_apostadores(self, apostadores):
        ...
        for apostador in self.apostadores:
            ...
            boton_editar.clicked.connect(partial(self.mostrar_dialogo_editar_apostador, apostador.id_apostador) )
            ...
            etiqueta_eliminar.clicked.connect(partial(self.eliminar_apostador, apostador.id_apostador) )
            etiqueta_eliminar.setToolTip(str(apostador.id_apostador))      
    ...
    def eliminar_apostador(self, indice_apostador):
        ...
        """ 
        print("indice_apostador->" + str(indice_apostador))   
