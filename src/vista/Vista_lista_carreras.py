...
class Vista_lista_carreras(QWidget):
    ...
    def mostrar_carreras(self, lista_carreras):
        ...
        if (self.carreras!= None and len(self.carreras)>=0) :
            ...
            for dic_carrera in self.carreras:
                ...
                id_carrera=dic_carrera["id"]
                
                print("id_carrera->"+  str(id_carrera))
                ...
                btn_editar.clicked.connect(partial(self.mostrar_apuestas,id_carrera ) )
                ...
                btn_terminar.clicked.connect(partial(self.terminar_carrera,id_carrera) )
                ...
                btn_eliminar.clicked.connect(partial(self.eliminar_carrera,id_carrera) )
    ...
    def mostrar_apostadores(self):       
        ...
        allApostadores= _logicaEporra.dar_apostadores()
        print("apostadores total:" + str(len(allApostadores)))
    ...
    def mostrar_apuestas(self,id_carrera): 
        ...
        #TODO:pupo       
        #_logicaEporra=Logica_Eporra()
        #allApuestaCarrera= _logicaEporra.dar_apuestas_carrera(id_carrera)
        #print("Apuestas Vista_lista_carrera total:" + str(len(allApuestaCarrera)))
        self.hide()
    ...
    def eliminar_carrera(self,id_carrera): 
        ...
        if respuesta == QMessageBox.Yes:
             self.interfaz.eliminar_carrera(id_carrera)
